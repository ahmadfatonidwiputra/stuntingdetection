...
<div class="page-header flex-between">
    ...
    <div style="display: flex; gap: 10px; flex-wrap: wrap;">
        <a href="{{ route('measurements.anak.download', array_merge(['anak' => $anak->id], request()->query())) }}" class="btn btn-secondary">
...
<div class="glass-card fade-in">
    ...
    <div id="historyTableRegion">
        @include('measurements.partials.history-table')
    </div>
</div>
@endsection
...
<script>
(function () {
    const region = document.getElementById('historyTableRegion');
    if (!region) return;
    ...
    // Sort headers only change the query string on this same page, so swap the
    // table in place instead of a full reload.
