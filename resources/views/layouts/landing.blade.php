...
<head>
    ...
    <meta name="description" content="AI Stunt Detect - Sistem deteksi dini stunting berbasis AI untuk posyandu Indonesia. Pantau pertumbuhan anak dengan teknologi kecerdasan buatan.">
    ...
    <style>
        *, *::before, *::after {
        ...
        .theme-toggle-btn:hover { background: var(--glass-hover); }
        ...
        .btn-outline:hover { background: var(--glass-hover); border-color: var(--glass-hover-border); }
        ...
        .footer-brand p { color: var(--text-muted); font-size: 14px; line-height: 1.7; margin-top: 12px; }
        .footer-links h4 { font-size: 14px; font-weight: 700; margin-bottom: 16px; text-transform: uppercase; letter-spacing: 1px; }
        .footer-links a {
        ...
        <nav class="navbar" id="navbar">
            <div class="nav-container">
                ...
                <ul class="nav-links">
                    ...
                    <li><a href="{{ route('tentang-stunting') }}" class="{{ request()->routeIs('tentang-stunting') ? 'active' : '' }}">Tentang Stunting</a></li>
        ...
        <footer class="footer">
            <div class="footer-inner">
                <div class="footer-brand">
                    ...
                    <p>Sistem deteksi dini stunting berbasis kecerdasan buatan untuk mendukung program posyandu di Indonesia.</p>
                </div>
            ...
            <div class="footer-bottom">
                &copy; {{ date('Y') }} AI Stunt Detect &mdash; Sistem Deteksi Stunting berbasis AI untuk Posyandu Indonesia
            </div>
        </footer>
    </div>
