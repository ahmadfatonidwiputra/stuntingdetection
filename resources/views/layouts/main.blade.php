            ...
            <aside class="sidebar" id="sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    @if(Auth::user()->isSuperAdmin())
                        ...
                        <a href="{{ route('super-admin.petugas.index') }}" class="nav-link {{ request()->routeIs('super-admin.petugas.*') ? 'active' : '' }}">
                            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    @else
                        ...
                        <a href="{{ route('verifikasi-orang-tua.index') }}" class="nav-link {{ request()->routeIs('verifikasi-orang-tua.*') ? 'active' : '' }}">
                            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        ...
                        <a href="{{ route('measurements.index') }}" class="nav-link {{ request()->routeIs('measurements.index') || request()->routeIs('measurements.show') || request()->routeIs('measurements.anak.show') ? 'active' : '' }}">
                            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
