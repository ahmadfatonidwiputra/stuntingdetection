...
@section('title', 'Tambah Posyandu - AI Stunt Detect')
...
<div class="form-main">
    ...
    <div class="form-card">
        <div class="form-card-title">🏥 Tambah Posyandu Baru</div>
        ...
        <form method="POST" action="{{ route('super-admin.posyandu.store') }}">
            @csrf

            <div class="form-grid">
                <div class="form-group" style="grid-column: span 2;">
                    <label class="form-label">Nama Posyandu <span style="color:var(--danger)">*</span></label>
                    <input type="text" name="nama" class="form-input" value="{{ old('nama') }}" placeholder="cth. Posyandu Melati 1" required>
                    @error('nama') <div class="form-error">{{ $message }}</div> @enderror
                </div>
                <div class="form-group">
                    <label class="form-label">Kode Posyandu</label>
                    <input type="text" name="kode_posyandu" class="form-input" value="{{ old('kode_posyandu') }}" placeholder="POS-XXX-001">
                    @error('kode_posyandu') <div class="form-error">{{ $message }}</div> @enderror
                </div>
                <div class="form-group">
                    <label class="form-label">No. Telepon</label>
                    <input type="text" name="no_telepon" class="form-input" value="{{ old('no_telepon') }}" placeholder="0361...">
                </div>
                <div class="form-group" style="grid-column: span 2;">
                    <label class="form-label">Alamat</label>
                    <textarea name="alamat" class="form-input" rows="2" placeholder="Jl. ...">{{ old('alamat') }}</textarea>
                </div>
                <div class="form-group">
                    <label class="form-label">Kelurahan</label>
                    <input type="text" name="kelurahan" class="form-input" value="{{ old('kelurahan') }}">
                </div>
                <div class="form-group">
                    <label class="form-label">Kecamatan</label>
                    <input type="text" name="kecamatan" class="form-input" value="{{ old('kecamatan') }}">
                </div>
                <div class="form-group">
                    <label class="form-label">Kota / Kabupaten</label>
                    <input type="text" name="kota" class="form-input" value="{{ old('kota') }}">
                </div>
                <div class="form-group">
                    <label class="form-label">Provinsi</label>
                    <input type="text" name="provinsi" class="form-input" value="{{ old('provinsi') }}">
                </div>
                <div class="form-group" style="grid-column: span 2;">
